...
dim(inputData)
summary(inputData)
sapply(inputData, sd)  # sd(inputData$gre) performs standard deviation in every column of the data frame
str(inputData)
...
AIC(mylogit); AIC(mylogit2) #comparing models # lesser the AIC, better is the model
